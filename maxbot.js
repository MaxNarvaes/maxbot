...
var minAFKDuration = 10;
var maxAFKDuration = 10;
var AFKCooldown = 5;
var adminCommandTimeout = true;
const token = "thr1.AAAAAGWFaqKKLFUE4JgHog.hcGTKiI4hjc";
var goalDictionary = {};
/* ROOM */
const roomNumber = 0;
const roomName = "⭐ SINDICATO DEL HAX ⭐ | Mantenimiento";
...
var v2Map = '{"name":"SINDICATO 1V1","width":430,"height":200,"bg":{"type":"","color":"2a3a40","width":0,"height":0},"vertexes":[/* 0 */{"x":0,"y":200,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 1 */{"x":0,"y":80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a8b4bd"},/* 2 */{"x":0,"y":-80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a8b4bd"},/* 3 */{"x":0,"y":-200,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 4 */{"x":-368,"y":-65,"bCoef":0.1,"cMask":["ball"],"bias":2,"color":"a3acc2"},/* 5 */{"x":-400,"y":-65,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"a3acc2"},/* 6 */{"x":-400,"y":65,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"a3acc2"},/* 7 */{"x":-368,"y":65,"bCoef":0.1,"cMask":["ball"],"bias":2,"color":"a3acc2"},/* 8 */{"x":368,"y":-65,"bCoef":0.1,"cMask":["ball"],"bias":-2,"color":"e8e3e3"},/* 9 */{"x":400,"y":-65,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"e8e3e3"},/* 10 */{"x":400,"y":65,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"e8e3e3"},/* 11 */{"x":368,"y":65,"bCoef":0.1,"cMask":["ball"],"bias":-2,"color":"e8e3e3"},/* 12 */{"x":-368,"y":65,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":32},/* 13 */{"x":-368,"y":171.5,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":32},/* 14 */{"x":-368,"y":-65,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 15 */{"x":-368,"y":-171.5,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 16 */{"x":-368,"y":170,"bCoef":1.3,"cMask":["ball"],"color":"a3acc2"},/* 17 */{"x":368,"y":170,"bCoef":1.3,"cMask":["ball"],"color":"a3acc2"},/* 18 */{"x":368,"y":65,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 19 */{"x":368,"y":171.5,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 20 */{"x":368,"y":-171.5,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 21 */{"x":368,"y":-65,"bCoef":1.1,"cMask":["ball"],"color":"a3acc2","bias":-32},/* 22 */{"x":-368,"y":-170,"cMask":["ball"],"color":"a3acc2"},/* 23 */{"x":368,"y":-170,"cMask":["ball"],"color":"a3acc2"},/* 24 */{"x":0,"y":-170,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a8b4bd"},/* 25 */{"x":0,"y":-80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a8b4bd","curve":0},/* 26 */{"x":0,"y":80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 27 */{"x":0,"y":170,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 28 */{"x":-366.5,"y":122,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 29 */{"x":-366.5,"y":-122,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 30 */{"x":366.5,"y":122,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 31 */{"x":366.5,"y":-122,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 32 */{"x":-368,"y":65,"bCoef":0.1,"cMask":[],"color":"c4c9d4","curve":0},/* 33 */{"x":-368,"y":-65,"bCoef":0.1,"cMask":[],"color":"c4c9d4","curve":0},/* 34 */{"x":368,"y":65,"bCoef":0.1,"cMask":[],"color":"c4c9d4","curve":0},/* 35 */{"x":368,"y":-65,"bCoef":0.1,"cMask":[],"color":"c4c9d4","curve":0},/* 36 */{"x":-400,"y":-66.5,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"a3acc2"},/* 37 */{"x":-400,"y":66.5,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"a3acc2"},/* 38 */{"x":400,"y":-66.5,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"e8e3e3"},/* 39 */{"x":400,"y":66.5,"bCoef":0.1,"cMask":["ball"],"bias":0,"color":"e8e3e3"},/* 40 */{"x":0,"y":78,"cGroup":["c1"],"color":"c691ff","curve":180},/* 41 */{"x":0,"y":-78,"cGroup":["c1"],"color":"c691ff","curve":180},/* 42 */{"x":0,"y":80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 43 */{"x":0,"y":-80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 44 */{"x":16.200000000000003,"y":57.24000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 45 */{"x":-34.56,"y":2.16,"cMask":["wall"],"cGroup":["wall"]},/* 46 */{"x":23.76,"y":50.76,"cMask":["wall"],"cGroup":["wall"]},/* 47 */{"x":41.04000000000001,"y":37.80000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 48 */{"x":5.4,"y":23.76,"cMask":["wall"],"cGroup":["wall"]},/* 49 */{"x":-22.680000000000003,"y":28.080000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 50 */{"x":-23.76,"y":-32.400000000000006,"cMask":["wall"],"cGroup":["wall"]},/* 51 */{"x":-23.76,"y":-6.48,"cMask":["wall"],"cGroup":["wall"]},/* 52 */{"x":2.16,"y":-11.88,"cMask":["wall"],"cGroup":["wall"]},/* 53 */{"x":-24.84,"y":-59.400000000000006,"cMask":["wall"],"cGroup":["wall"]},/* 54 */{"x":0,"y":-31.320000000000007,"cMask":["wall"],"cGroup":["wall"]},/* 55 */{"x":10.8,"y":1.0799999999999983,"cMask":["wall"],"cGroup":["wall"]},/* 56 */{"x":23.76,"y":-5.4,"cMask":["wall"],"cGroup":["wall"]},/* 57 */{"x":14.040000000000001,"y":-37.800000000000004,"cMask":["wall"],"cGroup":["wall"]},/* 58 */{"x":-1.08,"y":7.5600000000000005,"cMask":["wall"],"cGroup":["wall"]},/* 59 */{"x":38.88,"y":-11.88,"cMask":["wall"],"cGroup":["wall"]},/* 60 */{"x":37.8,"y":1.08,"cMask":["wall"],"cGroup":["wall"]},/* 61 */{"x":7.5600000000000005,"y":14.040000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 62 */{"x":16.200000000000003,"y":-74.52000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 63 */{"x":15.12,"y":-59.4,"cMask":["wall"],"cGroup":["wall"]},/* 64 */{"x":-14.040000000000003,"y":-84.24000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 65 */{"x":-8.64,"y":-71.28,"cMask":["wall"],"cGroup":["wall"]},/* 66 */{"x":1.08,"y":-96.12,"cMask":["wall"],"cGroup":["wall"]},/* 67 */{"x":-4.32,"y":-110.16000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 68 */{"x":-12.96,"y":-39.96000000000001,"cMask":["wall"],"cGroup":["wall"],"curve":90},/* 69 */{"x":-26.080000000000002,"y":-40.20000000000001,"cMask":["wall"],"cGroup":["wall"],"curve":90},/* 70 */{"x":-16.200000000000003,"y":-58.32000000000001,"cMask":["wall"],"cGroup":["wall"],"curve":180},/* 71 */{"x":-18.360000000000003,"y":-47.52,"cMask":["wall"],"cGroup":["wall"],"curve":180}],"segments":[{"v0":4,"v1":5,"color":"a3acc2","bCoef":0.1,"cMask":["ball"],"bias":2,"y":-65},{"v0":6,"v1":7,"color":"a3acc2","bCoef":0.1,"cMask":["ball"],"bias":2,"y":65},{"v0":8,"v1":9,"color":"e8e3e3","bCoef":0.1,"cMask":["ball"],"bias":-2,"y":-65},{"v0":10,"v1":11,"color":"e8e3e3","bCoef":0.1,"cMask":["ball"],"bias":-2,"y":65},{"v0":0,"v1":1,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":2,"v1":3,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":12,"v1":13,"color":"a3acc2","bCoef":1.1,"cMask":["ball"],"bias":32,"x":-368},{"v0":14,"v1":15,"color":"a3acc2","bCoef":1.1,"cMask":["ball"],"bias":-32,"x":-368},{"v0":16,"v1":17,"color":"a3acc2","cMask":["ball"],"y":170},{"v0":18,"v1":19,"color":"a3acc2","bCoef":1.1,"cMask":["ball"],"bias":-32,"x":368},{"v0":20,"v1":21,"color":"a3acc2","bCoef":1.1,"cMask":["ball"],"bias":-32,"x":368},{"v0":22,"v1":23,"color":"a3acc2","bCoef":2,"cMask":["ball"],"y":-170},{"v0":24,"v1":25,"color":"a8b4bd","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":26,"v1":27,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":29,"v1":28,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":[]},{"v0":30,"v1":31,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":[]},{"v0":33,"v1":32,"curve":0,"color":"c4c9d4","bCoef":0.1,"cMask":[]},{"v0":35,"v1":34,"curve":0,"color":"c4c9d4","bCoef":0.1,"cMask":[],"x":368},{"v0":36,"v1":37,"color":"a3acc2","bCoef":0.1,"cMask":["ball"],"bias":0,"x":-400},{"v0":38,"v1":39,"color":"e8e3e3","bCoef":0.1,"cMask":["ball"],"bias":0},{"v0":40,"v1":41,"curve":180,"vis":true,"color":"d0d5e1","cGroup":["c1"]},{"v0":41,"v1":40,"curve":180,"vis":true,"color":"c691ff","cGroup":["c1"]},{"v0":42,"v1":43,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["blueKO"],"curveF":6.1232339957368e-17},{"v0":43,"v1":42,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO"],"curveF":6.1232339957368e-17},{"v0":44,"v1":45,"curve":180,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":46,"v1":47,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":46,"v1":48,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":48,"v1":49,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":49,"v1":50,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":51,"v1":52,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":50,"v1":53,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":53,"v1":50,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":54,"v1":55,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":56,"v1":57,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":54,"v1":57,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":55,"v1":56,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":58,"v1":59,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":59,"v1":60,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":60,"v1":61,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":58,"v1":61,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":60,"v1":60,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":60,"v1":60,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":62,"v1":63,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":64,"v1":65,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":66,"v1":67,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":68,"v1":69,"curve":90,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":70,"v1":71,"curve":180,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":71,"v1":70,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2}],"planes":[{"normal":[0,1],"dist":-170,"bCoef":1.1,"cMask":["ball"]},{"normal":[0,-1],"dist":-170,"bCoef":1.1,"cMask":["ball"]},{"normal":[0,1],"dist":-200,"bCoef":0.1},{"normal":[0,-1],"dist":-200,"bCoef":0.1},{"normal":[1,0],"dist":-430,"bCoef":0.1},{"normal":[-1,0],"dist":-430,"bCoef":0.1},{"normal":[1,0],"dist":-400,"bCoef":0.1,"cMask":["ball"]},{"normal":[-1,0],"dist":-400,"bCoef":0.1,"cMask":["ball"]}],"goals":[{"p0":[368,65],"p1":[368,-65],"team":"blue","color":"c4c9d4"},{"p0":[-368,-65],"p1":[-368,65],"team":"red","color":"c4c9d4"}],"discs":[{"radius":4.5,"invMass":0,"pos":[-368,65],"color":"C10B31"},{"radius":4.5,"invMass":0,"pos":[-368,-65],"color":"C10B31"},{"radius":4.5,"invMass":0,"pos":[368,65],"color":"2519CF"},{"radius":4.5,"invMass":0,"pos":[368,-65],"color":"2519CF"}],"playerPhysics":{"bCoef":0.35,"acceleration":0.11,"kickingAcceleration":0.083,"kickStrength":4.65},"ballPhysics":{"radius":6.5,"bCoef":0.465,"invMass":1.4,"color":"ffffff"},"spawnDistance":180,"traits":[],"joints":[],"redSpawnPoints":[],"blueSpawnPoints":[],"canBeStored":false}';
var v3Map = '{"name":"SINDICATO 3V3","width":648,"height":270,"bg":{"type":"","color":"2a3a40","width":0,"height":0},"vertexes":[/* 0 */{"x":550,"y":240,"cMask":["ball"]},/* 1 */{"x":550,"y":-240,"cMask":["ball"]},/* 2 */{"x":0,"y":270,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 3 */{"x":0,"y":80,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 4 */{"x":0,"y":-80,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"],"color":"a3acc2"},/* 5 */{"x":0,"y":-270,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 6 */{"x":-550,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 7 */{"x":-590,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 8 */{"x":-590,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 9 */{"x":-550,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 10 */{"x":550,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 11 */{"x":590,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 12 */{"x":590,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 13 */{"x":550,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 14 */{"x":-550,"y":80,"cMask":["ball"],"color":"a3acc2"},/* 15 */{"x":-550,"y":240,"cMask":["ball"],"color":"a3acc2"},/* 16 */{"x":-550,"y":-80,"cMask":["ball"],"color":"a3acc2"},/* 17 */{"x":-550,"y":-240,"cMask":["ball"],"color":"a3acc2"},/* 18 */{"x":-550,"y":240,"cMask":["ball"],"color":"a3acc2"},/* 19 */{"x":550,"y":240,"cMask":["ball"],"color":"a3acc2"},/* 20 */{"x":550,"y":80,"cMask":["ball"],"color":"a3acc2"},/* 21 */{"x":550,"y":240,"cMask":["ball"],"color":"a3acc2"},/* 22 */{"x":550,"y":-240,"cMask":["ball"],"color":"a3acc2"},/* 23 */{"x":550,"y":-80,"cMask":["ball"],"color":"a3acc2"},/* 24 */{"x":550,"y":-240,"bCoef":0,"cMask":["ball"]},/* 25 */{"x":550,"y":-240,"bCoef":0,"cMask":["ball"]},/* 26 */{"x":-550,"y":-240,"cMask":["ball"],"color":"a3acc2"},/* 27 */{"x":550,"y":-240,"cMask":["ball"],"color":"a3acc2"},/* 28 */{"x":0,"y":-240,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 29 */{"x":0,"y":-82,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"],"color":"a3acc2"},/* 30 */{"x":0,"y":82,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 31 */{"x":0,"y":240,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 32 */{"x":0,"y":-82,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 33 */{"x":0,"y":82,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 34 */{"x":0,"y":82,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 35 */{"x":0,"y":-82,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 36 */{"x":0,"y":82,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 37 */{"x":0,"y":-82,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 38 */{"x":-557.5,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 39 */{"x":-557.5,"y":240,"bCoef":2,"cMask":["ball"]},/* 40 */{"x":-557.5,"y":-240,"bCoef":2,"cMask":["ball"]},/* 41 */{"x":-557.5,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 42 */{"x":557.5,"y":-240,"bCoef":2,"cMask":["ball"]},/* 43 */{"x":557.5,"y":-80,"bCoef":0.1,"cMask":["ball"]},/* 44 */{"x":557.5,"y":80,"bCoef":0.1,"cMask":["ball"]},/* 45 */{"x":557.5,"y":240,"bCoef":2,"cMask":["ball"]},/* 46 */{"x":0,"y":82,"bCoef":0.1,"cMask":[]},/* 47 */{"x":-550,"y":-80,"bCoef":0.1,"cMask":[]},/* 48 */{"x":-550,"y":80,"bCoef":0.1,"cMask":[]},/* 49 */{"x":550,"y":-80,"bCoef":0.1,"cMask":[]},/* 50 */{"x":550,"y":80,"bCoef":0.1,"cMask":[]},/* 51 */{"x":-548,"y":160,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 52 */{"x":-548,"y":-160,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 53 */{"x":548,"y":160,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 54 */{"x":548,"y":-160,"bCoef":0.1,"cMask":[],"color":"a3acc2"},/* 55 */{"x":480,"y":-2,"bCoef":0.1,"cMask":[]},/* 56 */{"x":480,"y":2,"bCoef":0.1,"cMask":[]},/* 57 */{"x":480,"y":-2,"bCoef":0.1,"cMask":[]},/* 58 */{"x":480,"y":2,"bCoef":0.1,"cMask":[]},/* 59 */{"x":-480,"y":-2,"bCoef":0.1,"cMask":[]},/* 60 */{"x":-480,"y":2,"bCoef":0.1,"cMask":[]},/* 61 */{"x":-480,"y":-2,"bCoef":0.1,"cMask":[]},/* 62 */{"x":-480,"y":2,"bCoef":0.1,"cMask":[]},/* 63 */{"x":16.883911680000004,"y":57.57619188060358,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"],"color":"f5b602"},/* 64 */{"x":-31.012224000000018,"y":-7.9626350757750455,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"],"color":"f5b602"},/* 65 */{"x":25.046845440000006,"y":51.05906944000002,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 66 */{"x":38.372712960000015,"y":36.814668800000014,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 67 */{"x":5.006300279396434,"y":25.924456840603572,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 68 */{"x":-19.84929024000001,"y":30.93075712000001,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 69 */{"x":-16.698957038792873,"y":-39.86956282030179,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 70 */{"x":-19.270973499698226,"y":-13.368160981508916,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 71 */{"x":5.572016460905348,"y":-13.722349662112483,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 72 */{"x":-9.860082304526747,"y":-63.299039780521255,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 73 */{"x":-7.288065843621398,"y":-52.153635116598075,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 74 */{"x":-7.288065843621398,"y":-42.72290809327846,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 75 */{"x":-16.718792866941012,"y":-46.98902606310015,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 76 */{"x":2.9999999999999982,"y":-30.720164609053494,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 77 */{"x":9.858710562414263,"y":0.14403292181069993,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 78 */{"x":25.29080932784636,"y":-3.2853223593964334,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 79 */{"x":16.71742112482853,"y":-34.149519890260635,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 80 */{"x":-3.0013717421124824,"y":3.5733882030178314,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 81 */{"x":35.57887517146776,"y":-5.857338820301783,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 82 */{"x":33.00685871056241,"y":6.1454046639231805,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 83 */{"x":11.573388203017831,"y":12.146776406035666,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 84 */{"x":19.289437585733882,"y":-52.153635116598075,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 85 */{"x":23.576131687242796,"y":-64.15637860082305,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 86 */{"x":7.286694101508916,"y":-72.72976680384087,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 87 */{"x":12.860082304526747,"y":-86.5912208504801,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},/* 88 */{"x":14.574759945130314,"y":-101.16598079561042,"bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]}],"segments":[{"v0":6,"v1":7,"color":"DB7F89","bCoef":0.1,"cMask":["ball"]},{"v0":7,"v1":8,"color":"DB7F89","bCoef":0.1,"cMask":["ball"]},{"v0":8,"v1":9,"color":"DB7F89","bCoef":0.1,"cMask":["ball"]},{"v0":10,"v1":11,"color":"7FA8DB","bCoef":0.1,"cMask":["ball"]},{"v0":11,"v1":12,"color":"7FA8DB","bCoef":0.1,"cMask":["ball"]},{"v0":12,"v1":13,"color":"7FA8DB","bCoef":0.1,"cMask":["ball"]},{"v0":2,"v1":3,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":3,"v1":4,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["blueKO"],"curveF":6.1232339957368e-17},{"v0":4,"v1":3,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO"],"curveF":6.1232339957368e-17},{"v0":4,"v1":5,"vis":false,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":14,"v1":15,"color":"a3acc2","cMask":["ball"]},{"v0":16,"v1":17,"color":"a3acc2","cMask":["ball"]},{"v0":18,"v1":19,"color":"a3acc2","cMask":["ball"]},{"v0":20,"v1":21,"color":"a3acc2","cMask":["ball"]},{"v0":22,"v1":23,"color":"a3acc2","cMask":["ball"]},{"v0":24,"v1":25,"color":"F8F8F8","bCoef":0,"cMask":["ball"]},{"v0":26,"v1":27,"color":"a3acc2","cMask":["ball"]},{"v0":28,"v1":29,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":30,"v1":31,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":38,"v1":39,"vis":false,"color":"F8F8F8","bCoef":2,"cMask":["ball"]},{"v0":40,"v1":41,"vis":false,"color":"F8F8F8","bCoef":2,"cMask":["ball"]},{"v0":42,"v1":43,"vis":false,"color":"F8F8F8","bCoef":2,"cMask":["ball"]},{"v0":44,"v1":45,"vis":false,"color":"F8F8F8","bCoef":2,"cMask":["ball"]},{"v0":47,"v1":48,"color":"F8F8F8","bCoef":0.1,"cMask":[]},{"v0":49,"v1":50,"color":"F8F8F8","bCoef":0.1,"cMask":[]},{"v0":52,"v1":51,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":53,"v1":54,"curve":180,"color":"a3acc2","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":56,"v1":55,"curve":180,"color":"686763","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":57,"v1":58,"curve":180,"color":"686763","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":60,"v1":59,"curve":180,"color":"686763","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":61,"v1":62,"curve":180,"color":"686763","bCoef":0.1,"cMask":[],"curveF":6.1232339957368e-17},{"v0":63,"v1":64,"curve":191.60416397318934,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":65,"v1":66,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":65,"v1":67,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":67,"v1":68,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":68,"v1":69,"curve":8.408996688972096,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":70,"v1":71,"curve":-47.13144030282425,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":69,"v1":72,"curve":190,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":72,"v1":69,"curve":190,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":72,"v1":73,"curve":190,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":73,"v1":72,"curve":162.05474677020808,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":74,"v1":75,"curve":40,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":76,"v1":77,"curve":40,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":78,"v1":79,"curve":40,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":76,"v1":79,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":77,"v1":78,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":80,"v1":81,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":81,"v1":82,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":82,"v1":83,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":80,"v1":83,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":84,"v1":85,"curve":-102.68038349182054,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":86,"v1":4,"curve":103.72033743034781,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]},{"v0":87,"v1":88,"curve":40,"color":"f5b602","bCoef":0.1,"cMask":["wall"],"cGroup":["wall"]}],"planes":[{"normal":[0,1],"dist":-240,"cMask":["ball"]},{"normal":[0,-1],"dist":-240,"cMask":["ball"]},{"normal":[0,1],"dist":-270,"bCoef":0.1},{"normal":[0,-1],"dist":-270,"bCoef":0.1},{"normal":[1,0],"dist":-642,"bCoef":0.1},{"normal":[-1,0],"dist":-644,"bCoef":0.1},{"normal":[1,0],"dist":-642,"bCoef":0.1,"cMask":["ball"]},{"normal":[-1,0],"dist":-643,"bCoef":0.1,"cMask":["ball"]}],"goals":[{"p0":[-556.3,-80],"p1":[-556.3,80],"team":"red"},{"p0":[556.3,80],"p1":[556.3,-80],"team":"blue"}],"discs":[{"radius":5,"invMass":0,"pos":[-550,80],"color":"E4E4E5"},{"radius":5,"invMass":0,"pos":[-550,-80],"color":"E4E4E5"},{"radius":5,"invMass":0,"pos":[550,80],"color":"E4E4E5"},{"radius":5,"invMass":0,"pos":[550,-80],"color":"E4E4E5"}],"playerPhysics":{"bCoef":0,"acceleration":0.11,"kickingAcceleration":0.083,"kickStrength":4.2},"ballPhysics":{"radius":5.8,"bCoef":0.412,"invMass":1.5,"color":"FFF26D"},"spawnDistance":350,"traits":{},"joints":[],"redSpawnPoints":[],"blueSpawnPoints":[],"canBeStored":false}';
var v4Map = '{"name":"SINDICATO 4V4","width":780,"height":350,"spawnDistance":350,"bg":{"type":"","color":"2a3a40","width":0,"height":0},"vertexes":[/* 0 */{"x":-700,"y":320,"trait":"ballArea","bias":-15,"color":"a3acc2"},/* 1 */{"x":-700,"y":80,"trait":"ballArea","bias":-15,"color":"a3acc2"},/* 2 */{"x":-700,"y":-80,"trait":"ballArea","bias":-15,"color":"a3acc2"},/* 3 */{"x":-700,"y":-320,"trait":"ballArea","bias":-15,"color":"a3acc2"},/* 4 */{"x":700,"y":320,"trait":"ballArea","bias":15,"color":"a3acc2"},/* 5 */{"x":700,"y":80,"trait":"ballArea","bias":15,"color":"a3acc2"},/* 6 */{"x":700,"y":-80,"trait":"ballArea","bias":15,"color":"a3acc2"},/* 7 */{"x":700,"y":-320,"trait":"ballArea","bias":15,"color":"a3acc2"},/* 8 */{"x":0,"y":320,"trait":"kickOffBarrier","color":"a3acc2"},/* 9 */{"x":0,"y":80,"trait":"kickOffBarrier","color":"a3acc2"},/* 10 */{"x":0,"y":-80,"cMask":["wall"],"cGroup":["wall"],"trait":"kickOffBarrier","color":"a3acc2"},/* 11 */{"x":0,"y":-320,"trait":"kickOffBarrier","color":"a3acc2"},/* 12 */{"x":-700,"y":-80,"trait":"goalNet","color":"002033"},/* 13 */{"x":-730,"y":-60,"trait":"goalNet","color":"002033"},/* 14 */{"x":-730,"y":60,"trait":"goalNet","color":"002033"},/* 15 */{"x":-700,"y":80,"trait":"goalNet","color":"002033"},/* 16 */{"x":700,"y":-80,"trait":"goalNet","color":"002033"},/* 17 */{"x":730,"y":-60,"trait":"goalNet","color":"002033"},/* 18 */{"x":730,"y":60,"trait":"goalNet","color":"002033"},/* 19 */{"x":700,"y":80,"trait":"goalNet","color":"002033"},/* 20 */{"x":700,"y":-320,"trait":"line","bias":15,"color":"a3acc2"},/* 21 */{"x":-700,"y":-320,"trait":"line","bias":15,"color":"a3acc2"},/* 22 */{"x":700,"y":320,"trait":"line","bias":-15,"color":"a3acc2"},/* 23 */{"x":-700,"y":320,"trait":"line","bias":-15,"color":"a3acc2"},/* 24 */{"x":-700,"y":-80,"trait":"line","color":"00290B"},/* 25 */{"x":-700,"y":80,"trait":"line","color":"00290B"},/* 26 */{"x":700,"y":-80,"trait":"line","color":"00290B"},/* 27 */{"x":700,"y":80,"trait":"line","color":"00290B"},/* 28 */{"x":0,"y":320,"trait":"kickOffBarrier"},/* 29 */{"x":0,"y":350,"trait":"kickOffBarrier"},/* 30 */{"x":0,"y":-320,"trait":"kickOffBarrier"},/* 31 */{"x":0,"y":-350,"trait":"kickOffBarrier"},/* 32 */{"x":-700,"y":275,"trait":"line"},/* 33 */{"x":700,"y":275,"trait":"line"},/* 34 */{"x":700,"y":-275,"trait":"line"},/* 35 */{"x":-690,"y":-320,"trait":"line","color":"007D11"},/* 36 */{"x":-700,"y":-310,"trait":"line","color":"007D11"},/* 37 */{"x":-700,"y":310,"trait":"line","color":"007D11"},/* 38 */{"x":-690,"y":320,"trait":"line","color":"007D11"},/* 39 */{"x":700,"y":310,"trait":"line","color":"007D11"},/* 40 */{"x":690,"y":320,"trait":"line","color":"007D11"},/* 41 */{"x":690,"y":-320,"trait":"line","color":"007D11"},/* 42 */{"x":700,"y":-310,"trait":"line","color":"007D11"},/* 43 */{"x":-700,"y":-80,"trait":"ballArea"},/* 44 */{"x":-700,"y":-320,"trait":"ballArea"},/* 45 */{"x":-700,"y":320,"trait":"ballArea"},/* 46 */{"x":-700,"y":80,"trait":"ballArea"},/* 47 */{"x":700,"y":320,"trait":"ballArea"},/* 48 */{"x":700,"y":80,"trait":"ballArea"},/* 49 */{"x":700,"y":-80,"trait":"ballArea"},/* 50 */{"x":700,"y":-320,"trait":"ballArea"},/* 51 */{"x":-450,"y":-321.59374237060547,"bCoef":-0.5,"cMask":["ball"],"trait":"line","color":"a3a3a3"},/* 52 */{"x":-450,"y":319.40625762939453,"bCoef":-0.5,"cMask":["ball"],"trait":"line","color":"a3a3a3"},/* 53 */{"x":450,"y":-321.59374237060547,"bCoef":-0.5,"cMask":["ball"],"trait":"goalNet","color":"a3a3a3"},/* 54 */{"x":450,"y":319.40625762939453,"bCoef":-0.5,"cMask":["ball"],"trait":"goalNet","color":"a3a3a3"},/* 55 */{"x":-400,"y":-319,"trait":"line","curve":0,"color":"a3acc2"},/* 56 */{"x":-400,"y":318,"trait":"line","curve":0,"color":"a3acc2"},/* 57 */{"x":400,"y":-319,"trait":"line","curve":0,"color":"a3acc2"},/* 58 */{"x":400,"y":318,"trait":"line","curve":0,"color":"a3acc2"},/* 59 */{"x":-700,"y":-130,"trait":"line","curve":0,"color":"a3acc2"},/* 60 */{"x":-595,"y":-130,"trait":"line","curve":50,"color":"a3acc2"},/* 61 */{"x":700,"y":-130,"trait":"line","color":"a3acc2"},/* 62 */{"x":595,"y":-130,"trait":"line","color":"a3acc2"},/* 63 */{"x":-700,"y":130,"trait":"line","color":"a3acc2"},/* 64 */{"x":-595,"y":130,"trait":"line","curve":0,"color":"a3acc2"},/* 65 */{"x":700,"y":130,"trait":"line","color":"a3acc2"},/* 66 */{"x":595,"y":130,"trait":"line","color":"a3acc2"},/* 67 */{"x":-399,"y":-136,"trait":"line","color":"a3acc2"},/* 68 */{"x":-402,"y":130,"trait":"line","color":"a3acc2"},/* 69 */{"x":399,"y":-136,"trait":"line","color":"a3acc2"},/* 70 */{"x":402,"y":130,"trait":"line","color":"a3acc2"},/* 71 */{"x":21.6,"y":54.00000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 72 */{"x":-32.40000000000001,"y":-4.319999999999996,"cMask":["wall"],"cGroup":["wall"]},/* 73 */{"x":30.240000000000006,"y":45.360000000000014,"cMask":["wall"],"cGroup":["wall"]},/* 74 */{"x":44.28000000000001,"y":30.240000000000006,"cMask":["wall"],"cGroup":["wall"]},/* 75 */{"x":11.88,"y":22.680000000000007,"cMask":["wall"],"cGroup":["wall"]},/* 76 */{"x":-15.120000000000005,"y":29.160000000000007,"cMask":["wall"],"cGroup":["wall"]},/* 77 */{"x":-20.520000000000003,"y":-36.720000000000006,"cMask":["wall"],"cGroup":["wall"]},/* 78 */{"x":-19.440000000000005,"y":-4.32,"cMask":["wall"],"cGroup":["wall"]},/* 79 */{"x":7.5600000000000005,"y":-10.800000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 80 */{"x":-16.200000000000003,"y":-64.80000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 81 */{"x":-10.800000000000002,"y":-42.12000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 82 */{"x":-22.680000000000007,"y":-47.52000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 83 */{"x":-8.640000000000002,"y":-60.48000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 84 */{"x":-15.120000000000003,"y":-51.84000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 85 */{"x":5.400000000000001,"y":-34.56000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 86 */{"x":12.960000000000003,"y":5.400000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 87 */{"x":30.240000000000002,"y":0,"cMask":["wall"],"cGroup":["wall"]},/* 88 */{"x":21.600000000000005,"y":-37.80000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 89 */{"x":1.0800000000000003,"y":6.480000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 90 */{"x":42.12000000000001,"y":-2.1600000000000006,"cMask":["wall"],"cGroup":["wall"]},/* 91 */{"x":37.800000000000004,"y":6.480000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 92 */{"x":9.719999999999999,"y":14.040000000000004,"cMask":["wall"],"cGroup":["wall"]},/* 93 */{"x":23.760000000000005,"y":-69.12000000000002,"cMask":["wall"],"cGroup":["wall"]},/* 94 */{"x":19.440000000000005,"y":-54.000000000000014,"cMask":["wall"],"cGroup":["wall"]},/* 95 */{"x":-8.400000000000002,"y":-94.64000000000001,"cMask":["wall"],"cGroup":["wall"]},/* 96 */{"x":9.720000000000002,"y":-117.72000000000003,"cMask":["wall"],"cGroup":["wall"]},/* 97 */{"x":11.880000000000003,"y":-99.36000000000003,"cMask":["wall"],"cGroup":["wall"]}],"segments":[{"v0":43,"v1":44,"trait":"ballArea"},{"v0":45,"v1":46,"trait":"ballArea"},{"v0":47,"v1":48,"trait":"ballArea"},{"v0":49,"v1":50,"trait":"ballArea"},{"v0":0,"v1":1,"vis":true,"color":"a3acc2","trait":"ballArea","bias":-15},{"v0":2,"v1":3,"vis":true,"color":"a3acc2","trait":"ballArea","bias":-15},{"v0":4,"v1":5,"vis":true,"color":"a3acc2","trait":"ballArea","bias":15},{"v0":6,"v1":7,"vis":true,"color":"a3acc2","trait":"ballArea","bias":15},{"v0":16,"v1":17,"curve":90,"color":"002033","trait":"goalNet"},{"v0":18,"v1":19,"curve":90,"color":"002033","trait":"goalNet"},{"v0":12,"v1":13,"curve":-90,"color":"002033","trait":"goalNet"},{"v0":14,"v1":15,"curve":-90,"color":"002033","trait":"goalNet"},{"v0":13,"v1":14,"color":"002033","trait":"goalNet"},{"v0":17,"v1":18,"color":"002033","trait":"goalNet"},{"v0":9,"v1":10,"curve":180,"color":"a3acc2","cGroup":["blueKO"],"trait":"kickOffBarrier"},{"v0":9,"v1":10,"curve":-180,"color":"a3acc2","cGroup":["redKO"],"trait":"kickOffBarrier"},{"v0":28,"v1":29,"vis":false,"trait":"kickOffBarrier"},{"v0":30,"v1":31,"vis":false,"trait":"kickOffBarrier"},{"v0":8,"v1":9,"color":"a3acc2","trait":"kickOffBarrier"},{"v0":10,"v1":11,"color":"a3acc2","trait":"kickOffBarrier"},{"v0":35,"v1":36,"curve":90,"color":"007D11","trait":"line"},{"v0":37,"v1":38,"curve":90,"color":"007D11","trait":"line"},{"v0":39,"v1":40,"curve":-90,"color":"007D11","trait":"line"},{"v0":41,"v1":42,"curve":-90,"color":"007D11","trait":"line"},{"v0":20,"v1":21,"color":"a3acc2","trait":"line","bias":15},{"v0":22,"v1":23,"color":"a3acc2","trait":"line","bias":-15},{"v0":24,"v1":25,"color":"00290B","trait":"line"},{"v0":26,"v1":27,"color":"00290B","trait":"line"},{"v0":55,"v1":56,"curve":0,"color":"a3acc2","trait":"line","x":-400},{"v0":57,"v1":58,"curve":0,"color":"a3acc2","trait":"line","x":400},{"v0":59,"v1":60,"curve":0,"color":"a3acc2","trait":"line"},{"v0":61,"v1":62,"curve":0,"color":"a3acc2","trait":"line"},{"v0":63,"v1":64,"curve":0,"color":"a3acc2","trait":"line"},{"v0":65,"v1":66,"curve":0,"color":"a3acc2","trait":"line"},{"v0":60,"v1":64,"curve":0,"color":"a3acc2","trait":"line"},{"v0":62,"v1":66,"curve":0,"color":"a3acc2","trait":"line"},{"v0":67,"v1":68,"curve":140,"color":"a3acc2","trait":"line"},{"v0":69,"v1":70,"curve":-140,"color":"a3acc2","trait":"line"},{"v0":71,"v1":72,"curve":180,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":73,"v1":74,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":73,"v1":75,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":75,"v1":76,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":76,"v1":77,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":78,"v1":79,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":77,"v1":80,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":80,"v1":77,"curve":172.93541083221805,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":81,"v1":82,"curve":90,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":83,"v1":84,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":84,"v1":83,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":85,"v1":86,"curve":30.922435480883802,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":87,"v1":88,"curve":56.144973871705886,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":85,"v1":88,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":86,"v1":87,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":89,"v1":90,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":90,"v1":91,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":91,"v1":92,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":89,"v1":92,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":93,"v1":94,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":10,"v1":95,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2},{"v0":96,"v1":97,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"],"bias":2}],"goals":[{"p0":[-710,-80],"p1":[-710,80],"team":"red"},{"p0":[710,80],"p1":[710,-80],"team":"blue"}],"discs":[{"radius":5.9,"pos":[-700,80],"color":"000203","trait":"goalPost"},{"radius":5.9,"pos":[-700,-80],"color":"000203","trait":"goalPost"},{"radius":5.9,"pos":[700,80],"color":"000203","trait":"goalPost"},{"radius":5.9,"pos":[700,-80],"color":"000203","trait":"goalPost"}],"planes":[{"normal":[0,1],"dist":-320,"trait":"ballArea"},{"normal":[0,-1],"dist":-320,"trait":"ballArea"},{"normal":[0,1],"dist":-350,"bCoef":0},{"normal":[0,-1],"dist":-350,"bCoef":0},{"normal":[1,0],"dist":-780,"bCoef":0},{"normal":[-1,0],"dist":-780,"bCoef":0}],"traits":{"line":{"cMask":[""],"color":"FFFFFF"},"ballArea":{"vis":false,"bCoef":1,"cMask":["ball"]},"goalPost":{"radius":8,"invMass":0,"color":"E50808"},"goalNet":{"bCoef":-0.5,"cMask":["ball"]},"kickOffBarrier":{"bCoef":0.1,"cGroup":["redKO","blueKO"],"cMask":["red","blue"],"color":"FFFFFF"}},"playerPhysics":{"bCoef":0.01,"kickStrength":4.545,"kickingAcceleration":0.09,"acceleration":0.113},"ballPhysics":{"radius":5.9,"bCoef":0.42,"color":"820400","invMass":1.5,"damping":0.99},"joints":[],"redSpawnPoints":[],"blueSpawnPoints":[],"canBeStored":false}';
var v6Map = '{"name":"SINDICATO 6V6","width":1500,"height":1100,"spawnDistance":350,"bg":{"type":"","color":"2a3a40","width":0,"height":0},"vertexes":[/* 0 */{"x":-700,"y":600,"trait":"ballArea"},/* 1 */{"x":-1200,"y":-600,"trait":"ballArea"},/* 2 */{"x":0,"y":600,"trait":"kickOffBarrier"},/* 3 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 4 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 5 */{"x":0,"y":-600,"trait":"kickOffBarrier"},/* 6 */{"x":-1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 7 */{"x":-1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 8 */{"x":-1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 9 */{"x":-1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 10 */{"x":1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 11 */{"x":1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 12 */{"x":1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 13 */{"x":1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 14 */{"x":-1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 15 */{"x":-1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 16 */{"x":-1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 17 */{"x":-1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 18 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 19 */{"x":1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 20 */{"x":1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 21 */{"x":1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 22 */{"x":1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 23 */{"x":1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 24 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 25 */{"x":1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 26 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 27 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 28 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 29 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 30 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 31 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 32 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 33 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 34 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 35 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 36 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 37 */{"x":-1200,"y":95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 38 */{"x":-1200,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 39 */{"x":-1200,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 40 */{"x":-1200,"y":-95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 41 */{"x":1200,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 42 */{"x":1200,"y":-95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 43 */{"x":1200,"y":95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 44 */{"x":1200,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 45 */{"x":-1200,"y":600,"trait":"ballArea"},/* 46 */{"x":-1200,"y":-600,"trait":"ballArea"},/* 47 */{"x":0,"y":600,"trait":"kickOffBarrier"},/* 48 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 49 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 50 */{"x":0,"y":-600,"trait":"kickOffBarrier"},/* 51 */{"x":-1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 52 */{"x":-1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 53 */{"x":-1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 54 */{"x":-1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 55 */{"x":1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 56 */{"x":1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 57 */{"x":1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 58 */{"x":1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 59 */{"x":-1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 60 */{"x":-1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 61 */{"x":-1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 62 */{"x":-1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 63 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 64 */{"x":1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 65 */{"x":1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 66 */{"x":1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 67 */{"x":1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 68 */{"x":1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 69 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 70 */{"x":1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 71 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 72 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 73 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 74 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 75 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 76 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 77 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 78 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 79 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 80 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 81 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 82 */{"x":-1200,"y":600,"trait":"ballArea"},/* 83 */{"x":-1200,"y":-600,"trait":"ballArea"},/* 84 */{"x":0,"y":600,"trait":"kickOffBarrier"},/* 85 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 86 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":180},/* 87 */{"x":0,"y":-600,"trait":"kickOffBarrier"},/* 88 */{"x":-1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 89 */{"x":-1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 90 */{"x":-1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 91 */{"x":-1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 92 */{"x":1200,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 93 */{"x":1250,"y":-95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 94 */{"x":1250,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 95 */{"x":1200,"y":95,"trait":"goalNet","curve":0,"color":"F8F8F8"},/* 96 */{"x":-1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 97 */{"x":-1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 98 */{"x":-1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 99 */{"x":-1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 100 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 101 */{"x":1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 102 */{"x":1200,"y":95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 103 */{"x":1200,"y":600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},/* 104 */{"x":1200,"y":-600,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 105 */{"x":1200,"y":-95,"bCoef":1.25,"cMask":["ball"],"trait":"ballArea","color":"F8F8F8"},/* 106 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 107 */{"x":1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 108 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 109 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 110 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 111 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 112 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 113 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 114 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 115 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 116 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":-180},/* 117 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 118 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"F8F8F8","vis":true,"curve":0},/* 119 */{"x":-1200,"y":600,"trait":"ballArea"},/* 120 */{"x":-1200,"y":-600,"trait":"ballArea"},/* 121 */{"x":0,"y":600,"trait":"kickOffBarrier"},/* 122 */{"x":0,"y":220,"trait":"kickOffBarrier","color":"a3acc2","vis":true,"curve":180},/* 123 */{"x":0,"y":-220,"trait":"kickOffBarrier","color":"a3acc2","vis":true,"curve":180},/* 124 */{"x":0,"y":-600,"trait":"kickOffBarrier"},/* 125 */{"x":-1200,"y":-95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 126 */{"x":-1250,"y":-95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 127 */{"x":-1250,"y":95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 128 */{"x":-1200,"y":95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 129 */{"x":1200,"y":-95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 130 */{"x":1250,"y":-95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 131 */{"x":1250,"y":95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 132 */{"x":1200,"y":95,"trait":"goalNet","curve":0,"color":"a3acc2"},/* 133 */{"x":-1200,"y":95,"bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","color":"a3acc2"},/* 134 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","color":"a3acc2"},/* 135 */{"x":-1200,"y":-95,"bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","color":"a3acc2"},/* 136 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","color":"a3acc2"},/* 137 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 138 */{"x":1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 139 */{"x":1200,"y":95,"bCoef":2,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 140 */{"x":1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 141 */{"x":1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 142 */{"x":1200,"y":-95,"bCoef":2,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 143 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 144 */{"x":1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea"},/* 145 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"a3acc2"},/* 146 */{"x":0,"y":-220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"a3acc2"},/* 147 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"a3acc2"},/* 148 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier","color":"a3acc2"},/* 149 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"trait":"kickOffBarrier","vis":true,"color":"F8F8F8"},/* 150 */{"x":0,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 151 */{"x":-1,"y":220,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},/* 152 */{"x":-800,"y":-100,"bCoef":0,"cMask":[""],"trait":"line","curve":20,"color":"F8F8F8"},/* 153 */{"x":800,"y":-100,"bCoef":0,"cMask":[""],"trait":"line","curve":-20},/* 154 */{"x":800,"y":100,"bCoef":0,"cMask":[""],"trait":"line","curve":-20},/* 155 */{"x":-800,"y":100,"bCoef":0,"cMask":[""],"trait":"line","curve":20,"color":"F8F8F8"},/* 156 */{"x":-1200,"y":95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 157 */{"x":-1200,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 158 */{"x":-1200,"y":95,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 159 */{"x":-1200,"y":600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false},/* 160 */{"x":-1200,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 161 */{"x":-1200,"y":-600,"bCoef":2,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 162 */{"x":1200,"y":-95,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 163 */{"x":1200,"y":-95,"bCoef":2,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0},/* 164 */{"x":-1207,"y":95,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 165 */{"x":-1207,"y":600,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 166 */{"x":-1207,"y":-600,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 167 */{"x":-1207,"y":-95,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 168 */{"x":1207,"y":-600,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 169 */{"x":1207,"y":-95,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 170 */{"x":1207,"y":95,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 171 */{"x":1207,"y":600,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},/* 172 */{"x":800,"y":100,"bCoef":0,"cMask":[""],"trait":"line","curve":-90,"color":"a3acc2"},/* 173 */{"x":1200,"y":400,"bCoef":0,"cMask":[""],"trait":"line","curve":-90,"color":"a3acc2"},/* 174 */{"x":1200,"y":-400,"bCoef":0,"cMask":[""],"trait":"line","curve":-90,"color":"a3acc2"},/* 175 */{"x":800,"y":-100,"bCoef":0,"cMask":[""],"trait":"line","curve":-90,"color":"a3acc2"},/* 176 */{"x":-800,"y":100,"bCoef":0,"cMask":[""],"trait":"line","curve":90,"color":"a3acc2"},/* 177 */{"x":-1200,"y":400,"bCoef":0,"cMask":[""],"trait":"line","curve":90,"color":"a3acc2"},/* 178 */{"x":-1200,"y":-400,"bCoef":0,"cMask":[""],"trait":"line","curve":90,"color":"a3acc2"},/* 179 */{"x":-800,"y":-100,"bCoef":0,"cMask":[""],"trait":"line","curve":90,"color":"a3acc2"},/* 180 */{"x":-1200,"y":-95,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"dd807e"},/* 181 */{"x":-1200,"y":95,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"dd807e"},/* 182 */{"x":1200,"y":-95,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"90c1dd"},/* 183 */{"x":1200,"y":95,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"90c1dd"},/* 184 */{"x":0,"y":-220,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"a3acc2"},/* 185 */{"x":0,"y":220,"bCoef":0,"cMask":[""],"trait":"line","curve":0,"color":"a3acc2"},/* 186 */{"x":73.46640384000003,"y":157.21810421760006,"cMask":["wall"],"cGroup":["wall"]},/* 187 */{"x":-88.15968460800003,"y":-19.10126499840001,"cMask":["wall"],"cGroup":["wall"]},/* 188 */{"x":91.09834076160004,"y":141.05549537280007,"cMask":["wall"],"cGroup":["wall"]},/* 189 */{"x":126.36221460480004,"y":116.07691806720003,"cMask":["wall"],"cGroup":["wall"]},/* 190 */{"x":33.79454576640002,"y":74.93573191680004,"cMask":["wall"],"cGroup":["wall"]},/* 191 */{"x":-48.487826534400014,"y":85.22102845440004,"cMask":["wall"],"cGroup":["wall"]},/* 192 */{"x":-70.52774768640002,"y":-113.13826191360003,"cMask":["wall"],"cGroup":["wall"]},/* 193 */{"x":-60.24245114880002,"y":-30.855889612800006,"cMask":["wall"],"cGroup":["wall"]},/* 194 */{"x":11.754624614400004,"y":-45.549170380800014,"cMask":["wall"],"cGroup":["wall"]},/* 195 */{"x":-69.05841960960002,"y":-185.13533767680005,"cMask":["wall"],"cGroup":["wall"]},/* 196 */{"x":-79.34371614720003,"y":-113.13826191360005,"cMask":["wall"],"cGroup":["wall"]},/* 197 */{"x":-5.877312307200001,"y":-92.56766883840004,"cMask":["wall"],"cGroup":["wall"]},/* 198 */{"x":17.631936921600005,"y":-1.469328076800001,"cMask":["wall"],"cGroup":["wall"]},/* 199 */{"x":54.365138841600015,"y":-11.754624614400004,"cMask":["wall"],"cGroup":["wall"]},/* 200 */{"x":22.03992115200001,"y":-99.91430922240004,"cMask":["wall"],"cGroup":["wall"]},/* 201 */{"x":-5.877312307200002,"y":4.407984230400001,"cMask":["wall"],"cGroup":["wall"]},/* 202 */{"x":79.34371614720003,"y":-17.631936921600005,"cMask":["wall"],"cGroup":["wall"]},/* 203 */{"x":71.99707576320003,"y":5.877312307200004,"cMask":["wall"],"cGroup":["wall"]},/* 204 */{"x":19.10126499840001,"y":20.57059307520001,"cMask":["wall"],"cGroup":["wall"]},/* 205 */{"x":-44.07984230400002,"y":-126.36221460480004,"cMask":["wall"],"cGroup":["wall"]},/* 206 */{"x":-72.75170037760003,"y":-129.11683921920005,"cMask":["wall"],"cGroup":["wall"]},/* 207 */{"x":-47.01849845760002,"y":-173.38071306240008,"cMask":["wall"],"cGroup":["wall"]},/* 208 */{"x":-55.83446691840002,"y":-152.81011998720007,"cMask":["wall"],"cGroup":["wall"]},/* 209 */{"x":16.162608844800005,"y":-145.46347960320006,"cMask":["wall"],"cGroup":["wall"]},/* 210 */{"x":20.57059307520001,"y":-188.07399383040007,"cMask":["wall"],"cGroup":["wall"]},/* 211 */{"x":-20.57059307520001,"y":-189.54332190720007,"cMask":["wall"],"cGroup":["wall"]},/* 212 */{"x":-35.51072096010241,"y":-228.237195212882,"cMask":["wall"],"cGroup":["wall"]},/* 213 */{"x":14.693280768000005,"y":-252.7244292096001,"cMask":["wall"],"cGroup":["wall"]},/* 214 */{"x":11.754624614400004,"y":-300.72561428496397,"cMask":["wall"],"cGroup":["wall"]}],"segments":[{"v0":6,"v1":7,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":7,"v1":8,"color":"F8F8F8","trait":"goalNet"},{"v0":8,"v1":9,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":10,"v1":11,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":11,"v1":12,"color":"F8F8F8","trait":"goalNet"},{"v0":12,"v1":13,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":2,"v1":3,"trait":"kickOffBarrier"},{"v0":4,"v1":5,"trait":"kickOffBarrier"},{"v0":14,"v1":15,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},{"v0":16,"v1":17,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":-1200},{"v0":20,"v1":21,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":22,"v1":23,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":24,"v1":25,"curve":0,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"trait":"ballArea","y":-600},{"v0":26,"v1":27,"vis":true,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":28,"v1":29,"vis":true,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":37,"v1":38,"curve":0,"vis":false,"color":"F8F8F8","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-700},{"v0":39,"v1":40,"curve":0,"vis":false,"color":"F8F8F8","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-1200},{"v0":41,"v1":42,"curve":0,"vis":false,"color":"F8F8F8","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":43,"v1":44,"curve":2.50208708167,"vis":false,"color":"F8F8F8","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":51,"v1":52,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":52,"v1":53,"color":"F8F8F8","trait":"goalNet"},{"v0":53,"v1":54,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":55,"v1":56,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":56,"v1":57,"color":"F8F8F8","trait":"goalNet"},{"v0":57,"v1":58,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":47,"v1":48,"trait":"kickOffBarrier"},{"v0":49,"v1":50,"trait":"kickOffBarrier"},{"v0":59,"v1":60,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},{"v0":61,"v1":62,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":-1200},{"v0":65,"v1":66,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":67,"v1":68,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":71,"v1":72,"vis":true,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":88,"v1":89,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":89,"v1":90,"color":"F8F8F8","trait":"goalNet"},{"v0":90,"v1":91,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":92,"v1":93,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":93,"v1":94,"color":"F8F8F8","trait":"goalNet"},{"v0":94,"v1":95,"curve":0,"color":"F8F8F8","trait":"goalNet"},{"v0":84,"v1":85,"trait":"kickOffBarrier"},{"v0":86,"v1":87,"trait":"kickOffBarrier"},{"v0":96,"v1":97,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea"},{"v0":98,"v1":99,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":-1200},{"v0":102,"v1":103,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":104,"v1":105,"vis":true,"color":"F8F8F8","bCoef":1.25,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":108,"v1":109,"vis":true,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":110,"v1":111,"vis":true,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":125,"v1":126,"curve":0,"color":"a3acc2","trait":"goalNet"},{"v0":126,"v1":127,"color":"a3acc2","trait":"goalNet"},{"v0":127,"v1":128,"curve":0,"color":"a3acc2","trait":"goalNet"},{"v0":129,"v1":130,"curve":0,"color":"a3acc2","trait":"goalNet"},{"v0":130,"v1":131,"color":"a3acc2","trait":"goalNet"},{"v0":131,"v1":132,"curve":0,"color":"a3acc2","trait":"goalNet"},{"v0":122,"v1":123,"curve":180,"vis":true,"color":"a3acc2","cGroup":["blueKO"],"trait":"kickOffBarrier"},{"v0":122,"v1":123,"curve":-180,"vis":true,"color":"a3acc2","cGroup":["redKO"],"trait":"kickOffBarrier"},{"v0":123,"v1":124,"trait":"kickOffBarrier"},{"v0":133,"v1":134,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea"},{"v0":135,"v1":136,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","x":-1200},{"v0":137,"v1":138,"curve":0,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"trait":"ballArea","y":600},{"v0":139,"v1":140,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":141,"v1":142,"vis":true,"color":"a3acc2","bCoef":2,"cMask":["ball"],"trait":"ballArea","x":1200},{"v0":145,"v1":146,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":147,"v1":148,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"trait":"kickOffBarrier"},{"v0":153,"v1":154,"curve":-20,"vis":true,"color":"F8F8F8","bCoef":0,"cMask":[""],"trait":"line"},{"v0":152,"v1":155,"curve":20,"vis":true,"color":"F8F8F8","bCoef":0,"cMask":[""],"trait":"line"},{"v0":164,"v1":165,"vis":false,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","x":-707},{"v0":166,"v1":167,"vis":false,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","x":-1207},{"v0":168,"v1":169,"vis":false,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","x":1207},{"v0":170,"v1":171,"vis":false,"bCoef":1.5,"cMask":["ball"],"cGroup":["ball"],"trait":"ballArea","x":1207},{"v0":172,"v1":173,"curve":-90,"vis":true,"color":"a3acc2","bCoef":0,"cMask":[""],"trait":"line"},{"v0":174,"v1":175,"curve":-90,"vis":true,"color":"a3acc2","bCoef":0,"cMask":[""],"trait":"line"},{"v0":176,"v1":177,"curve":90,"vis":true,"color":"a3acc2","bCoef":0,"cMask":[""],"trait":"line"},{"v0":178,"v1":179,"curve":90,"vis":true,"color":"a3acc2","bCoef":0,"cMask":[""],"trait":"line"},{"v0":180,"v1":181,"curve":0,"vis":true,"color":"dd807e","bCoef":0,"cMask":[""],"trait":"line"},{"v0":182,"v1":183,"curve":0,"vis":true,"color":"90c1dd","bCoef":0,"cMask":[""],"trait":"line"},{"v0":186,"v1":187,"curve":177.9935326176756,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":188,"v1":189,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":188,"v1":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":190,"v1":191,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":191,"v1":192,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":193,"v1":194,"curve":-43.973364355484776,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":192,"v1":195,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":195,"v1":196,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":197,"v1":198,"curve":29.50480682679377,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":199,"v1":200,"curve":35.86503824702473,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":197,"v1":200,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":198,"v1":199,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":201,"v1":202,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":202,"v1":203,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":203,"v1":204,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":201,"v1":204,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":205,"v1":206,"curve":71.07318418258869,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":207,"v1":208,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":208,"v1":207,"curve":190,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":209,"v1":210,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":211,"v1":212,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]},{"v0":213,"v1":214,"curve":40,"color":"f5b602","cMask":["wall"],"cGroup":["wall"]}],"goals":[{"p0":[-1207,95],"p1":[-1207,-95],"team":"red"},{"p0":[1207,95],"p1":[1207,-95],"team":"blue"},{"p0":[-1207,95],"p1":[-1207,-95],"team":"red"},{"p0":[1207,95],"p1":[1207,-95],"team":"blue"},{"p0":[-1207,95],"p1":[-1207,-95],"team":"red"},{"p0":[1207,95],"p1":[1207,-95],"team":"blue"},{"p0":[-1207,95],"p1":[-1207,-95],"team":"red"},{"p0":[1207,95],"p1":[1207,-95],"team":"blue"}],"discs":[{"radius":6,"pos":[-1200,95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[-1200,-95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[1199,95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[1199,-95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[-1200,95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[-1200,-95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[1199,95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[1199,-95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[-1200,95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[-1200,-95],"color":"FF0000","trait":"goalPost"},{"radius":6,"pos":[1199,95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[1199,-95],"color":"0033FF","trait":"goalPost"},{"radius":6,"pos":[-1200,95],"color":"D90000","trait":"goalPost"},{"radius":6,"pos":[-1200,-95],"color":"D90000","trait":"goalPost"},{"radius":6,"pos":[1199,95],"color":"0080FF","trait":"goalPost"},{"radius":6,"pos":[1199,-95],"color":"0080FF","trait":"goalPost"}],"planes":[{"normal":[0,1],"dist":-600,"trait":"ballArea","vis":false,"curve":0},{"normal":[0,-1],"dist":-600,"trait":"ballArea"},{"normal":[0,1],"dist":-660,"bCoef":0.1},{"normal":[0,-1],"dist":-660,"bCoef":0.1},{"normal":[1,0],"dist":-1330,"bCoef":0.1},{"normal":[-1,0],"dist":-1330,"bCoef":0.1},{"normal":[0,1],"dist":-600,"trait":"ballArea","vis":false,"curve":0},{"normal":[0,-1],"dist":-600,"trait":"ballArea"},{"normal":[0,1],"dist":-660,"bCoef":0.1},{"normal":[0,-1],"dist":-660,"bCoef":0.1},{"normal":[1,0],"dist":-1330,"bCoef":0.1},{"normal":[-1,0],"dist":-1330,"bCoef":0.1},{"normal":[0,1],"dist":-600,"trait":"ballArea","vis":false,"curve":0},{"normal":[0,-1],"dist":-600,"trait":"ballArea"},{"normal":[0,1],"dist":-660,"bCoef":0.1},{"normal":[0,-1],"dist":-660,"bCoef":0.1},{"normal":[1,0],"dist":-1330,"bCoef":0.1},{"normal":[-1,0],"dist":-1330,"bCoef":0.1},{"normal":[0,1],"dist":-600,"trait":"ballArea","vis":false,"curve":0},{"normal":[0,1],"dist":-660,"bCoef":0.1},{"normal":[0,-1],"dist":-660,"bCoef":0.1},{"normal":[1,0],"dist":-1330,"bCoef":0.1},{"normal":[-1,0],"dist":-1330,"bCoef":0.1}],"traits":{"ballArea":{"vis":false,"bCoef":1,"cMask":["ball"]},"goalPost":{"radius":8,"invMass":0,"bCoef":0.5},"goalNet":{"vis":true,"bCoef":0.1,"cMask":["ball"]},"line":{"vis":true,"bCoef":0.1,"cMask":[""]},"kickOffBarrier":{"vis":false,"bCoef":0.1,"cGroup":["redKO","blueKO"],"cMask":["red","blue"]}},"playerPhysics":{"bCoef":0,"acceleration":0.11,"kickingAcceleration":0.083,"kickStrength":5},"ballPhysics":{"radius":6.4,"bCoef":0.4,"invMass":1.5,"damping":0.99,"color":"FFCC00"}}';
var v7Map = '{"name":"SINDICATO 7V7","canBeStored":false,"width":1265,"height":630,"bg":{"type":"","color":"2a3a40","width":0,"height":0},"vertexes":[/* 0 */{"x":0,"y":-631,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 1 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 2 */{"x":-1200,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[-700,-80]},/* 3 */{"x":-1235,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[-700,-80]},/* 4 */{"x":-1235,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[-700,80]},/* 5 */{"x":-1200,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[-700,80]},/* 6 */{"x":1200,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[1200,-120]},/* 7 */{"x":1235,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[1200,-120]},/* 8 */{"x":1235,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[1200,120]},/* 9 */{"x":1200,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"ffffff","pos":[1200,120]},/* 10 */{"x":-1200,"y":120,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2","pos":[-700,80]},/* 11 */{"x":-1200,"y":600,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 12 */{"x":-1200,"y":-120,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2","pos":[-700,-80]},/* 13 */{"x":-1200,"y":-600,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 14 */{"x":-1200,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 15 */{"x":1200,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 16 */{"x":1200,"y":120,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","pos":[1200,120],"color":"a3acc2"},/* 17 */{"x":1200,"y":600,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 18 */{"x":1200,"y":-600,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2"},/* 19 */{"x":1200,"y":-120,"bCoef":1.15,"cMask":["ball"],"trait":"ballArea","color":"a3acc2","pos":[1200,-120]},/* 20 */{"x":-1200,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 21 */{"x":1200,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"color":"a3acc2"},/* 22 */{"x":-1206.5,"y":120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"pos":[-700,80],"color":"ffffff"},/* 23 */{"x":-1206.5,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"color":"ffffff"},/* 24 */{"x":-1206.5,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"color":"ffffff"},/* 25 */{"x":-1206.5,"y":-120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"pos":[-700,-80],"color":"ffffff"},/* 26 */{"x":1206.5,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"color":"ffffff"},/* 27 */{"x":1206.5,"y":-120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"pos":[1200,-120],"color":"ffffff"},/* 28 */{"x":1206.5,"y":120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"pos":[1200,120],"color":"ffffff"},/* 29 */{"x":1206.5,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"color":"ffffff"},/* 30 */{"x":-1200,"y":-120,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"F80000"},/* 31 */{"x":-1200,"y":120,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"F80000"},/* 32 */{"x":1200,"y":-120,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"0000F8","pos":[1200,-120]},/* 33 */{"x":1200,"y":120,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"0000F8","pos":[1200,120]},/* 34 */{"x":-1200,"y":560,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 35 */{"x":-740,"y":100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 36 */{"x":-1200,"y":-560,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 37 */{"x":-740,"y":-100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 38 */{"x":1200,"y":560,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 39 */{"x":740,"y":100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 40 */{"x":1200,"y":-560,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 41 */{"x":740,"y":-100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 42 */{"x":740,"y":100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"ffffff","curve":0},/* 43 */{"x":740,"y":-100,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"ffffff","curve":0},/* 44 */{"x":740,"y":1,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 45 */{"x":740,"y":-1,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 46 */{"x":740,"y":3,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 47 */{"x":740,"y":-4,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 48 */{"x":740,"y":4,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 49 */{"x":-740,"y":1,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 50 */{"x":-740,"y":-1,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 51 */{"x":-740,"y":3,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 52 */{"x":-740,"y":-4,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 53 */{"x":-740,"y":4,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"ffffff"},/* 54 */{"x":-1200,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[-700,-80],"vis":false},/* 55 */{"x":-1235,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[-700,-80],"vis":false},/* 56 */{"x":-1235,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[-700,80],"vis":false},/* 57 */{"x":-1200,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[-700,80],"vis":false},/* 58 */{"x":1200,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[1200,-120],"vis":false},/* 59 */{"x":1235,"y":-120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[1200,-120],"vis":false},/* 60 */{"x":1235,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[1200,120],"vis":false},/* 61 */{"x":1200,"y":120,"bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","curve":0,"color":"a3acc2","pos":[1200,120],"vis":false},/* 62 */{"x":-1265.1,"y":15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false,"pos":[-1265.1,0]},/* 63 */{"x":-1235,"y":15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false},/* 64 */{"x":-1265.1,"y":-15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false,"pos":[-1265.1,0]},/* 65 */{"x":-1235,"y":-15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false},/* 66 */{"x":1235,"y":-15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false},/* 67 */{"x":1265.1,"y":-15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false,"pos":[610.1,0]},/* 68 */{"x":1235,"y":15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false},/* 69 */{"x":1265.1,"y":15,"bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","vis":false,"pos":[610.1,0]},/* 70 */{"x":0,"y":600,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 71 */{"x":0,"y":630,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 72 */{"x":0,"y":120,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"696969","curve":180},/* 73 */{"x":0,"y":-120,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"696969","curve":180},/* 74 */{"x":0,"y":120,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"696969"},/* 75 */{"x":0,"y":-120,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"696969"},/* 76 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"ffffff"},/* 77 */{"x":0,"y":120,"cMask":[],"color":"ffffff"},/* 78 */{"x":0,"y":600,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},/* 79 */{"x":0,"y":120,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"ffffff"},/* 80 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"ffffff"},/* 81 */{"x":0,"y":-60,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"a3acc2"},/* 82 */{"x":0,"y":60,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180,"color":"a3acc2"},/* 83 */{"x":0,"y":-60,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"ffffff","curve":-93.241608812827},/* 84 */{"x":0,"y":120,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"ffffff","curve":-93.241608812827},/* 85 */{"x":0,"y":60,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"ffffff","curve":93.241608812827},/* 86 */{"x":0,"y":-121,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180.5,"color":"555555"},/* 87 */{"x":0,"y":121,"bCoef":0.1,"cMask":["wall"],"trait":"line","curve":180.5,"color":"555555"},/* 88 */{"x":0,"y":-121,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 89 */{"x":0,"y":-600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 90 */{"x":0,"y":121,"bCoef":0,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 91 */{"x":0,"y":600,"bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"],"color":"a3acc2"},/* 92 */{"x":0,"y":121,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 93 */{"x":0,"y":60,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 94 */{"x":0,"y":-60,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":-93.241608812827},/* 95 */{"x":0,"y":-121,"bCoef":0.1,"cMask":["wall"],"trait":"line","color":"a3acc2","curve":93.241608812827},/* 96 */{"x":-1206.5,"y":120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"pos":[-700,80],"color":"ffffff"},/* 97 */{"x":-1206.5,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"color":"ffffff"},/* 98 */{"x":-1206.5,"y":-600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"color":"ffffff"},/* 99 */{"x":-1206.5,"y":-120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","vis":false,"curve":0,"pos":[-700,-80],"color":"ffffff"},/* 100 */{"x":1206.5,"y":120,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"pos":[1200,120],"color":"ffffff"},/* 101 */{"x":1206.5,"y":600,"bCoef":1,"cMask":["ball"],"trait":"ballArea","curve":0,"vis":false,"color":"ffffff"},/* 102 */{"x":1235,"y":-630,"bCoef":0.5,"cMask":["red","blue"],"color":"a3acc2"},/* 103 */{"x":1235,"y":630,"bCoef":0.5,"cMask":["red","blue"],"color":"a3acc2"},/* 104 */{"x":-1235,"y":-630,"bCoef":0.5,"cMask":["red","blue"],"color":"a3acc2"},/* 105 */{"x":-1235,"y":630,"bCoef":0.5,"cMask":["red","blue"],"color":"a3acc2"}],"segments":[{"v0":0,"v1":1,"vis":false,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":2,"v1":3,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[-700,-80],"y":-120},{"v0":3,"v1":4,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","x":-1235},{"v0":4,"v1":5,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[-700,80],"y":120},{"v0":6,"v1":7,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[1200,-120],"y":-120},{"v0":7,"v1":8,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","x":1235},{"v0":8,"v1":9,"curve":0,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[1200,120],"y":120},{"v0":10,"v1":11,"vis":true,"color":"a3acc2","bCoef":1.15,"cMask":["ball"],"trait":"ballArea","x":-550},{"v0":12,"v1":13,"vis":true,"color":"a3acc2","bCoef":1.15,"cMask":["ball"],"trait":"ballArea","x":-550},{"v0":14,"v1":15,"vis":true,"color":"a3acc2","bCoef":1,"cMask":["ball"],"trait":"ballArea","y":240},{"v0":16,"v1":17,"vis":true,"color":"a3acc2","bCoef":1.15,"cMask":["ball"],"trait":"ballArea","x":550},{"v0":18,"v1":19,"vis":true,"color":"a3acc2","bCoef":1.15,"cMask":["ball"],"trait":"ballArea","x":550},{"v0":20,"v1":21,"curve":0,"vis":true,"color":"a3acc2","bCoef":1,"cMask":["ball"],"trait":"ballArea","y":-600},{"v0":22,"v1":23,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-556.5},{"v0":24,"v1":25,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-556.5},{"v0":26,"v1":27,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":556.5},{"v0":28,"v1":29,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":556.5},{"v0":30,"v1":31,"curve":0,"vis":true,"color":"F80000","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-550},{"v0":32,"v1":33,"curve":0,"vis":true,"color":"0000F8","bCoef":0.1,"cMask":["wall"],"trait":"line","x":550},{"v0":34,"v1":35,"curve":-93.241608812827,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line"},{"v0":36,"v1":37,"curve":93.241608812827,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line"},{"v0":35,"v1":37,"curve":0,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":38,"v1":39,"curve":93.241608812827,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line"},{"v0":40,"v1":41,"curve":-93.241608812827,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line"},{"v0":42,"v1":43,"curve":0,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":740},{"v0":45,"v1":44,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":740},{"v0":44,"v1":45,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":740},{"v0":47,"v1":46,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":740},{"v0":46,"v1":47,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":740},{"v0":50,"v1":49,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":49,"v1":50,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":52,"v1":51,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":51,"v1":52,"curve":180,"vis":true,"color":"ffffff","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":54,"v1":55,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[-700,-80],"y":-120},{"v0":55,"v1":56,"curve":0,"vis":false,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","x":-1235},{"v0":56,"v1":57,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[-700,80],"y":120},{"v0":58,"v1":59,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[1200,-120],"y":-120},{"v0":59,"v1":60,"curve":0,"vis":false,"color":"ffffff","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","x":1235},{"v0":60,"v1":61,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.2,"cMask":["red","blue","ball"],"trait":"goalPost","pos":[1200,120],"y":120},{"v0":62,"v1":63,"curve":0,"vis":false,"color":"ffffff","bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","y":15},{"v0":64,"v1":65,"curve":0,"vis":false,"color":"ffffff","bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","y":-15},{"v0":66,"v1":67,"curve":0,"vis":false,"color":"ffffff","bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","y":-15},{"v0":68,"v1":69,"curve":0,"vis":false,"color":"ffffff","bCoef":0.5,"cMask":["red","blue"],"trait":"goalPost","y":15},{"v0":70,"v1":71,"vis":false,"color":"F8F8F8","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":72,"v1":73,"curve":180,"color":"696969","bCoef":0.1,"cMask":["red","blue"],"cGroup":["blueKO"],"curveF":0.0049891420830909},{"v0":75,"v1":74,"curve":180,"color":"696969","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO"],"curveF":6.1232339957368e-17},{"v0":82,"v1":81,"curve":180,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line","x":0},{"v0":81,"v1":82,"curve":180,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line","x":0},{"v0":87,"v1":86,"curve":180.5,"vis":true,"color":"555555","bCoef":0.1,"cMask":["wall"],"trait":"line","x":0},{"v0":86,"v1":87,"curve":180.5,"vis":true,"color":"555555","bCoef":0.1,"cMask":["wall"],"trait":"line","x":0},{"v0":89,"v1":88,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":90,"v1":91,"color":"a3acc2","bCoef":0.1,"cMask":["red","blue"],"cGroup":["redKO","blueKO"]},{"v0":92,"v1":93,"curve":0,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":94,"v1":95,"curve":0,"vis":true,"color":"a3acc2","bCoef":0.1,"cMask":["wall"],"trait":"line","x":-740},{"v0":96,"v1":97,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-556.5},{"v0":98,"v1":99,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":-556.5},{"v0":100,"v1":101,"curve":0,"vis":false,"color":"ffffff","bCoef":1,"cMask":["ball"],"trait":"ballArea","x":556.5},{"v0":102,"v1":103,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.5,"cMask":["red","blue"],"x":1235},{"v0":104,"v1":105,"curve":0,"vis":false,"color":"a3acc2","bCoef":0.5,"cMask":["red","blue"],"x":-1235}],"planes":[{"normal":[0,1],"dist":-630,"bCoef":0.1},{"normal":[-1,0],"dist":-1265.1,"bCoef":0.1},{"normal":[0,-1],"dist":-600,"cMask":["ball"]},{"normal":[0,-1],"dist":-630,"bCoef":0.1},{"normal":[1,0],"dist":-1265.1,"bCoef":0.1},{"normal":[0,1],"dist":-600,"cMask":["ball"]}],"goals":[{"p0":[-1207.5,-120],"p1":[-1207.5,120],"team":"red","color":"ffffff"},{"p0":[1207.5,120],"p1":[1207.5,-120],"team":"blue","color":"ffffff"}],"discs":[{"radius":0.01,"invMass":0,"pos":[-1265.1,0],"color":"000000","bCoef":470,"vis":true,"x":-1265.1},{"radius":0.1,"invMass":0,"pos":[1265.1,0],"color":"000000","bCoef":470},{"radius":6,"invMass":0,"pos":[-1200,120],"color":"ffffff","trait":"goalPost","y":85},{"radius":6,"invMass":0,"pos":[-1200,-120],"color":"ffffff","trait":"goalPost","y":-110,"x":-560},{"radius":6,"invMass":0,"pos":[1200,120],"color":"ffffff","trait":"goalPost","y":85},{"radius":6,"invMass":0,"pos":[1200,-120],"color":"ffffff","trait":"goalPost","y":-110,"vis":true}],"playerPhysics":{"bCoef":0.1,"acceleration":0.11,"kickingAcceleration":0.083,"kickStrength":5.2},"ballPhysics":{"radius":6.25,"bCoef":0.4,"invMass":1.5,"color":"FEBA01"},"spawnDistance":320,"traits":{}}';
...
function endGame(winner) { // handles the end of a game : no stopGame call inside
    ...
    room.sendAnnouncement("🎥 ¡EL PARTIDO FUÉ GRABADO Y SE ENVIÓ A NUESTRO DISCORD!: " + `${getDate()}-${roomNumber + 1}.hbr2`, null, Colors.Amrelo, 'bold');
...
room.onPlayerJoin = function (player) {
    ...
    if (localStorage.getItem(player.auth) != null) {
        ...
        if (playerRole != "vip") {
            ...
            room.sendAnnouncement(" EL VIP " + player.name + " ENTRO A LA SALA!", null, 0x05C5FF, "bold");
...
room.onPlayerTeamChange = function (changedPlayer, byPlayer) {
    ...
    if (isAFK(changedPlayer) && changedPlayer.team != Team.SPECTATORS && byPlayer != null && byPlayer.admin) {
        ...
        room.sendAnnouncement(changedPlayer.name + " está 𝐀𝐅𝐊! 😴", Colors.Laranja);
        return;
    }
...
function printYoutube() {
    room.sendAnnouncement("                                             📍 Síguenos en Youtube! ➡ https://www.youtube.com/@JueganTodosCon ", null, 0xF6FF43);
}

function printTiktok() {
    room.sendAnnouncement("                                             📍 Síguenos en TikTok! ➡ https://www.tiktok.com/@juegantodoscon ", null, 0xF6FF43);
}
...
function afkCommand(player, message) {
    if (AFKSet.has(player.id)) {
        if (AFKMinSet.has(player.id)) {
            ...
            AFKSet.delete(player, message) 
            room.sendAnnouncement(
                `🌅 ${player.name} ya no está 𝐀𝐅𝐊!`,
                null,
                Colors.Laranja,
                'bold',
                null
        ...
        if (AFKCooldownSet.has(player.id)) {
            room.sendAnnouncement(
                `Podes irte 𝐀𝐅𝐊 una vez cada ${AFKCooldown} minutos!`,
                player.id,
                Colors.Vermelho,
                'bold',
                null
                ...
                setTimeout(
                    (id) => {
                        ...
                        if (AFKSet.has(pid)) {
                            ...
                            if (!isAdmin) {
                                AFKSet.delete(pid);
                                room.kickPlayer(pid, "No podes estar afk mas de 10 minutos amigo.", false);
...
room.onPlayerChat = function (player, message) {
    ...
    */
    ...
    if (role != "player") {
        ...
        if (role == "master") {
            room.sendAnnouncement("「👨🏽‍💻 Manager」" + player.name + ": " + msg + "", null, 0x00FF00);
            return false;
        } else if (role == "head") {
